...
# contained in network_generator.py. This file is for testing post pip install
# of the causaln package

import unittest
import sys, os
#sys.path.append('..\\..\\')
#sys.path.append('..\\')
from causaln.network_generator import * # all tests are on this so shouldn't be confusing
import sys
