...
filestem = "ExampleTwo_SimpleFork_U1U2Noise"
...
## 2.  Scan multiple values of B, U1 and U2.
...
#
node_list = [X, B, Y, U1, U2]
network = ng.NetworkInstance(node_list)

# 2.  Select multiple pseudo-random values of B, U1, U2.
## 2.1 Scan values.
