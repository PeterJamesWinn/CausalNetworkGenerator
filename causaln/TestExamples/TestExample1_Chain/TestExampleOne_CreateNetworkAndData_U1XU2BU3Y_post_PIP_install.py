...
# if pip install has been run in the directory causaln/..
# then no need for relative paths to network_generator.py
# network_generator needs specifying as causaln.network_generator
import pandas as pd
import sys, os
#sys.path.append('..\\..\\') 
